...
/*
 * T-HEAD C906/C910 extended PTE attributes (bits 63:59). Without
 * cacheable/shareable, kernel mappings are treated as device memory
 * and AMOs hang after satp is programmed.
 */
