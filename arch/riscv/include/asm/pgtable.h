...
{
	return (pgd_val(pgd) & _PAGE_CHG_MASK) >> _PAGE_PFN_SHIFT;
}
 ...
 * Mask T-HEAD bits 63:59 (and other non-PFN flags) like the vendor 5.10 tree.
 */
...
#define __pmd_to_phys(pmd)  (((pmd_val(pmd) & _PAGE_CHG_MASK) >> _PAGE_PFN_SHIFT) << PAGE_SHIFT)
